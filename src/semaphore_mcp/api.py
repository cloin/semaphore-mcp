...
class SemaphoreAPIClient:
    ...
    def list_tasks(self, project_id: int) -> List[Dict[str, Any]]:
        ...
        return self._request("GET", f"project/{project_id}/tasks")
    
    def get_task(self, project_id: int, task_id: int) -> Dict[str, Any]:
        """Get a task by ID."""
        return self._request("GET", f"project/{project_id}/task/{task_id}")
    
    def run_task(self, project_id: int, template_id: int, environment: Optional[Dict[str, str]] = None) -> Dict[str, Any]:
        """
    ...
    def list_environments(self, project_id: int) -> List[Dict[str, Any]]:
        ...
        return self._request("GET", f"project/{project_id}/environment")
    
    def get_environment(self, project_id: int, environment_id: int) -> Dict[str, Any]:
        """Get an environment by ID."""
        return self._request("GET", f"project/{project_id}/environment/{environment_id}")
        
    def create_environment(self, project_id: int, name: str, env_data: Dict[str, str]) -> Dict[str, Any]:
    ...
    def update_environment(self, project_id: int, environment_id: int, name: str = None, 
                         env_data: Dict[str, str] = None) -> Dict[str, Any]:
        ...
        return self._request("PUT", f"project/{project_id}/environment/{environment_id}", json=payload)
    
    def delete_environment(self, project_id: int, environment_id: int) -> Dict[str, Any]:
        """Delete an environment by ID."""
        return self._request("DELETE", f"project/{project_id}/environment/{environment_id}")
        
    # Inventory endpoints
    def list_inventory(self, project_id: int) -> List[Dict[str, Any]]:
        """List all inventory items for a project."""
        return self._request("GET", f"project/{project_id}/inventory")
    ...
    def create_inventory(self, project_id: int, name: str, inventory_data: str) -> Dict[str, Any]:
    ...
    def update_inventory(self, project_id: int, inventory_id: int, name: str = None, 
                        inventory_data: str = None) -> Dict[str, Any]:
        ...
        return self._request("PUT", f"project/{project_id}/inventory/{inventory_id}", json=payload)
...
def create_client(base_url: Optional[str] = None, token: Optional[str] = None) -> SemaphoreAPIClient:
    """
    ...
    """
    base_url = base_url or os.environ.get("SEMAPHORE_URL", "http://localhost:3000")
    return SemaphoreAPIClient(base_url, token)
