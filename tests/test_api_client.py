...
def test_environment_operations(semaphore_client):
    ...
    try:
        ...
        # Create environment
        try:
            created_env = semaphore_client.create_environment(project_id, test_env_name, test_env_data)
...
def test_inventory_operations(semaphore_client):
    ...
    try:
        ...
        # Create inventory
        try:
            created_inv = semaphore_client.create_inventory(project_id, test_inv_name, test_inv_data)
